      ...
      <div
        className={`flex items-center gap-2.5 h-[52px] px-4 rounded-2xl bg-white/80 border transition-all
          ${error ? 'border-red-300 focus-within:border-red-400 focus-within:ring-2 focus-within:ring-red-100'
                  : 'border-gray-200 focus-within:border-brand-600 focus-within:ring-2 focus-within:ring-brand-600/15'}`}
      >
        {icon && (
          typeof icon === 'string'
        ...
        <input
          ...
          className="flex-1 bg-transparent border-none outline-none text-ink-900 placeholder:text-gray-400 text-sm"
        />
        {isPassword && (
