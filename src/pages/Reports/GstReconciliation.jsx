...
export default function GstReconciliation() {
  ...
  return <div className="min-h-screen bg-canvas-default p-4 md:p-6 space-y-5">
    <div><h1 className="text-xl md:text-2xl font-semibold text-ink-default">GST Reconciliation</h1><p className="text-sm text-ink-muted">LIVE TALLY · GSTR-2B reconciliation</p></div>
