...
export default function ReimbursementAudit() {
  ...
  return <div className="min-h-screen bg-canvas-default p-4 md:p-6 space-y-5">
    <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-semibold text-ink-default">Reimbursement Audit</h1><p className="text-sm text-ink-muted">LIVE TALLY · Reimbursement audit entries</p>
          </div>
        </div>
